...
async def _route_query(query: str) -> Dict[str, Any]:
    ...
    ctx = {"raw_query": query, "file_type": "csv", "raw_row_count": 1000, "raw_col_count": 10}
    ...
    # Safely extract values since real LLMs might not always return exact valid keys
    return {
        "intent": parsed.get("intent", "trend_analysis"),
