...
from backend.agents.router_node import router_node, llm_router

# --- Mock Logic from Day 4 ---
...
def patch_llm_router():
    with patch.object(llm_router, 'route', new_callable=AsyncMock, side_effect=_mock_route):
        yield
